...
Go through the [IDX customization](#customization) for more details.
...
- Customizable - you can choose predefined awesome themes and further customize the look and feel of your IDX framework.
