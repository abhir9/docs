---
title: IDX (Identity Experience Framework)
description: ""
...
**IDX (Identity Experience Framework)** is a ready-to-use web page available on a dedicated instance in LoginRadius and allows you to setup a centralized authentication page. It is a set of registration, login, and related web pages such as forgot password, profile.

The IDx allows you to set up a centralized authentication page. There are a few predefined layouts that can be further customized via your LoginRadius Dashboard under [Auth Page Customization](https://dashboard.loginradius.com/auth-page).

Go through the [IDX customization](/concepts/idx-overview#customization) for Detailed Overview


## Key Benefits

IDX is useful for authentication needs, you can direct your users to IDX and after successful authentication or registration, direct back to your domain.
...
- Customizable - you can choose predefind awesome themes and You can customize the look and feel of your IDx framework.
- Cut down on UI/UX design time - Utilize the classic login screen layout without the fuss.
- Less complexity - Using LoginRadius IDX means, don't need to handle authentication, new users registration, forgot password etc.
